...
@section('header', 'Gestion des Locaux')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#">Accueil</a></li>
    <li class="breadcrumb-item active" aria-current="page">Organisation</li>
    <li class="breadcrumb-item active" aria-current="page">Locaux</li>
@endsection
...
$(document).ready(function() {
    $('#btn-toggle-status').on('click', function() {
        const selections = $('#locaux-table').bootstrapTable('getSelections');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: route('organisation.locaux.toggle-status', id),
                    type: 'PATCH',
                    headers: {
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#locaux-table').bootstrapTable('refresh');
                        } else {
                            Swal.fire({
                                icon: 'error',
                                title: 'Erreur',
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Liste des locaux</h3>
    </div>
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <label for="filter_etage_id" class="form-label">Filtrer par Étage</label>
                <select class="form-select" id="filter_etage_id" disabled>
        ...
        <table id="locaux-table"
               data-toggle="table"
               data-url="{{ route('organisation.locaux.data') }}"
            ...
            <thead>
                <tr>
                    ...
                    <th data-field="type_local" data-sortable="true" data-formatter="typeLocalFormatter">Type</th>
                    <th data-field="superficie_m2" data-sortable="true">Superficie (m²)</th>
                    <th data-field="etage.libelle" data-sortable="true">Étage</th>
                    <th data-field="etage.batiment.libelle" data-sortable="true">Bâtiment</th>
                    <th data-field="etage.batiment.site.libelle" data-sortable="true">Site</th>
...
@include('organisation::organisation.locaux._modal')
@stop
...
<script>
    window.localRoutes = {
        ...
        etagesByBatiment: "{{ route('organisation.etages.by-batiment', ['batimentId' => ':batimentId']) }}",
        data: "{{ route('organisation.locaux.data') }}"
    };
    ...
    function typeLocalFormatter(value) {
        const labels = {
            'bureau': 'Bureau',
...
<script type="module" src="{{ asset('js/modules/organisation/locaux/index.js') }}"></script>
@endpush
