    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="userForm" enctype="multipart/form-data">
                ...
                <input type="hidden" id="dossier_employe_id" name="dossier_employe_id">

                <div class="modal-body">

                    {{-- Avatar + champs identité --}}
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            {{-- Section liaison employé --}}
                            <div class="card border-0 bg-light mb-2" id="employe-link-section">
                                <div class="card-body py-2 px-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="form-check form-switch ms-3 mb-0">
                                            <input class="form-check-input" type="checkbox" id="toggle-employe-link" role="switch" style="width:2.5em; height:1.4em;">
                                        </div>
                                    </div>
                                    <div id="employe-select-wrapper" class="mt-2 d-none">
                                        <label for="employe_select2" class="form-label small mb-1">Rechercher un employé</label>
                                        <select class="form-select" id="employe_select2" style="width:100%">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="password-group">
                        <hr>
                        <h6 id="password-label">Mot de passe <small class="text-muted">(Laisser vide si vous ne voulez pas modifier le mot de passe)</small></h6>
