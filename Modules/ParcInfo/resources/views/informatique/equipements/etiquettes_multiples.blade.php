...
<head>
    ...
    <title>Impression d'étiquettes ({{ count($equipements) }})</title>
    <!-- Fonts -->
...
<body>
    ...
    <div class="no-print-area">
        <button onclick="window.print()" class="btn-print">
            ...
            Imprimer les {{ count($equipements) }} étiquettes
        </button>
    </div>
        ...
        @foreach($equipements as $index => $equipement)
            <div class="label-container">
                <div class="label-header">
                    ...
                    <span class="category">{{ $equipement->categorie?->libelle ?? 'N/A' }}</span>
                </div>
                <div class="label-body">
                    <div class="qr-code-box" id="qrcode-{{ $index }}" data-qrcode="{{ $equipement->detail_route }}"></div>
                    <div class="info-box">
                        <div class="model-name" title="{{ $equipement->marque?->libelle }} {{ $equipement->modele }}">
                            {{ $equipement->marque?->libelle }} {{ $equipement->modele }}
                        </div>
                        <div class="info-item">S/N: <span class="info-value">{{ $equipement->numero_serie ?: 'N/A' }}</span></div>
    ...
    <script>
        document.querySelectorAll('.qr-code-box').forEach(el => {
            const qrContent = el.getAttribute('data-qrcode');
