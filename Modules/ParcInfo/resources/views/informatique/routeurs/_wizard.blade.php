<div class="modal fade" id="routeurModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius:16px">
            ...
            <div class="modal-header border-0 px-4 pt-4 pb-0">
                <div>
                    <h5 class="modal-title fw-bold mb-0" id="wizard-title">Ajouter un routeur</h5>
                    <small class="text-muted" id="wizard-subtitle">Réseau & Routage - CHU Yalgado</small>
                </div>
            ...
            <form id="routeurForm" novalidate>
                @csrf
                <input type="hidden" id="rt_id" name="id">
                ...
                <div class="modal-body px-4 py-3" style="min-height:340px">
                    ...
                    <div id="step-2" class="wizard-step d-none">
                        <h6 class="fw-bold mb-3"><i class="bi bi-info-circle text-primary me-2"></i>Informations techniques du Routeur</h6>
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" class="form-control field-input" name="modele" id="modele" placeholder="Ex: ISR 4331" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label field-label">Adresse IP (Management/WAN)</label>
                                <input type="text" class="form-control field-input" name="adresse_ip" id="adresse_ip" placeholder="Ex: 192.168.1.1">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                <label class="form-label field-label">Nombre de Ports RJ45/SFP</label>
                                <input type="number" class="form-control field-input" name="nb_ports" id="nb_ports" placeholder="Ex: 4" min="0">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control field-input" name="version_firmware" id="version_firmware" placeholder="Ex: IOS-XE 16.9">
                            </div>
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-0 d-flex justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="submit" class="btn btn-primary px-4 d-none" id="btn-submit">
                            <i class="bi bi-floppy me-1"></i> <span id="btn-submit-label">Enregistrer le routeur</span>
                        </button>
                    </div>
                </div>
            </form>
