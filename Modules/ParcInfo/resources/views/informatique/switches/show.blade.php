...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('parc-info.switches.index') }}">Switches</a></li>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="adresse_ip" value="{{ $reseau->adresse_ip ?? '' }}" disabled id="f_adresse_ip" placeholder="Ex: 192.168.1.10">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="passerelle" value="{{ $reseau->passerelle ?? '' }}" disabled id="f_passerelle" placeholder="Ex: 192.168.1.1">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label small fw-bold text-muted">Ports</label>
                                    <input type="number" class="form-control" name="nb_ports" value="{{ $reseau->nb_ports ?? '' }}" disabled id="f_nb_ports" placeholder="Ex: 24">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label small fw-bold text-muted">Vitesse (Mbps)</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="version_firmware" value="{{ $reseau->version_firmware ?? '' }}" disabled id="f_version_firmware" placeholder="Ex: IOS 15.0">
                                </div>
                                <div class="col-md-3 mt-auto">
                                    <div class="form-check mb-2">
                                        ...
                                        <label class="form-check-label small fw-bold text-muted" for="f_est_poe">Supporte PoE</label>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-auto">
                                    <div class="form-check mb-2">
                                        ...
                                        <label class="form-check-label small fw-bold text-muted" for="f_est_manageable">Manageable</label>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('js')
<script type="module" src="{{ asset('js/modules/parc-info/switches/index.js') }}?v={{ time() }}"></script>
...
$(function(){
    ...
    $('#btn-save-fiche').on('click', function(){
        ...
        $.ajax({
            url: route('parc-info.switches.update', '{{ $equipement->id }}'),
            method: 'PUT',
            data: $.param(formData),
            success: (res) => {
                if(res.success){
    ...
    $('[data-action="update-statut"]').on('click', function(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: route('parc-info.switches.update-statut', '{{ $equipement->id }}'),
                    method: 'PATCH',
    ...
    $('#btn-desaffecter').on('click', function(){
        Swal.fire({
            ...
            text: 'Le switch sera remis en stock. Indiquez le motif :',
            input: 'textarea',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                $.post(route('parc-info.switches.desaffecter', '{{ $equipement->id }}'), {
    ...
    $('#affectationForm').on('submit', function(e){
        ...
        $.post(route('parc-info.switches.store-affectation'), $(this).serialize(), (res) => {
            if (res.success) {
