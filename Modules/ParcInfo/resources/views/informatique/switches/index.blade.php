...
@section('header', 'Switches & Commutateurs')
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-3">
        <h6 class="mb-0 fw-bold">Liste des Switches & Commutateurs</h6>
    </div>
    <div class="card-body p-0">
        ...
        <table id="switches-table"
               data-toggle="table"
               data-url="{{ route('parc-info.switches.data') }}"
               ...
               data-page-size="25"
               data-query-params="switchesQueryParams"
            ...
            <thead class="table-light">
                <tr>
                    ...
                    <th data-field="est_poe" data-formatter="poeFormatter">PoE</th>
...
@include('parcinfo::informatique.switches._wizard')
