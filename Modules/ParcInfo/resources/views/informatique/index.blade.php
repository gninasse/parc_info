...
@section('header', $category->libelle)
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="rounded-3 bg-primary bg-opacity-10 p-3"><i class="bi {{ $category->icone }} fs-4 text-primary"></i></div>
                <div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-3">
        <h6 class="mb-0 fw-bold">Liste des {{ $category->libelle }}</h6>
    </div>
    <div class="card-body p-0">
        ...
        <table id="equipements-table"
               ...
               data-page-size="25"
               data-query-params="equipementsQueryParams"
            ...
            <thead class="table-light">
                <tr>
                    ...
                    {{-- Colonnes dynamiques --}}
                    @foreach($colonnesConfig as $col)
                        <th data-field="champs_valeurs_resolus.{{ $col->code }}" data-sortable="true">
                            {{ $col->libelle }}
                        </th>
                    @endforeach
...
@include('parcinfo::informatique._wizard')
...
<script>
    window.parcInfoConfig = {
        ...
        categoryLibelle: '{{ $category->libelle }}'
    };
</script>
<script src="{{ asset('plugins/bootstrap-table/bootstrap-table.min.js') }}"></script>
<script src="{{ asset('plugins/bootstrap-table/locale/bootstrap-table-fr-FR.min.js') }}"></script>
<script type="module" src="{{ asset('js/modules/parc-info/dynamic-index.js') }}?v={{ time() }}"></script>
