...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-3">
        <h6 class="mb-0 fw-bold">Liste des Scanners</h6>
    </div>
    <div class="card-body p-0">
        ...
        <table id="scanners-table"
               data-toggle="table"
               data-url="{{ route('parc-info.scanners.data') }}"
               ...
               data-page-size="25"
               data-query-params="scannersQueryParams"
...
@include('parcinfo::informatique.scanners._wizard')
@include('parcinfo::informatique.ordinateurs._selection_modals')
@endsection

@push('js')
<script>
    window.routePrefix = "parc-info.scanners";
</script>
<script src="{{ asset('plugins/bootstrap-table/bootstrap-table.min.js') }}"></script>
<script src="{{ asset('plugins/bootstrap-table/locale/bootstrap-table-fr-FR.min.js') }}"></script>
<script type="module" src="{{ asset('js/modules/parc-info/scanners/index.js') }}?v={{ time() }}"></script>
