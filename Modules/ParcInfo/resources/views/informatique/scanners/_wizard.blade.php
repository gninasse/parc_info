        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius:12px;overflow:hidden">
            <div class="modal-header bg-light border-0 py-3">
                <div class="d-flex align-items-center gap-2">
                    <div class="bg-primary bg-opacity-10 p-2 rounded-3"><i class="bi bi-upc-scan text-primary fs-5"></i></div>
                    <h5 class="modal-title fw-bold" id="wizard-title">Ajouter un Scanner / Lecteur</h5>
                </div>
            ...
            <form id="reseauForm">
                ...
                <div class="modal-body p-4 bg-light bg-opacity-50" style="min-height:50vh">
                    ...
                    <div class="wizard-step d-none" id="step-2">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Résolution Max (DPI)</label>
                                <input type="number" class="form-control" name="resolution_dpi_max" placeholder="Ex: 600">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Format Max</label>
                                <select class="form-select" name="format_max">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input" type="checkbox" name="est_recto_verso" value="1">
                                    <label class="form-check-label fw-semibold">Recto-Verso automatique</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input" type="checkbox" name="a_chargeur_auto" value="1">
                                    <label class="form-check-label fw-semibold">Chargeur automatique (ADF)</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wizard-step d-none" id="step-3">
                        ...
                        <div id="aff-selector">
                            <h6 class="fw-bold mb-3 text-primary">Emplacement</h6>
