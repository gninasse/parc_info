...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Terminaux IP</li>
@endsection
...
<div class="row g-3 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="rounded-3 bg-primary bg-opacity-10 p-3"><i class="bi bi-cpu-fill fs-4 text-primary"></i></div>
                <div>
                    <div class="text-muted small fw-semibold text-uppercase" style="font-size:.7rem;letter-spacing:.5px">Total Terminaux</div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="rounded-3 bg-success bg-opacity-10 p-3"><i class="bi bi-cpu fs-4 text-success"></i></div>
                <div>
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body py-3">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-3">
                <label class="form-label small fw-semibold mb-1">Type de Réseau / Matériel</label>
                <select class="form-select form-select-sm" id="filter-type-reseau">
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-3">
        <h6 class="mb-0 fw-bold">Liste des Terminaux IP</h6>
    </div>
    <div class="card-body p-0">
        ...
        <table id="terminaux-table"
               data-toggle="table"
               data-url="{{ route('parc-info.terminaux-ip.data') }}"
               ...
               data-page-size="25"
               data-query-params="terminauxQueryParams"
            ...
            <thead class="table-light">
                <tr>
                    ...
                    <th data-field="type_reseau" data-sortable="true">Type de Réseau</th>
...
@include('parcinfo::informatique.terminaux_ip._wizard')
...
<script type="module" src="{{ asset('js/modules/parc-info/terminaux-ip/index.js') }}?v={{ time() }}"></script>
