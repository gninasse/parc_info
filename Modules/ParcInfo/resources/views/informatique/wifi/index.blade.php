...
@section('header', 'Points d\'accès WiFi')
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="rounded-3 bg-primary bg-opacity-10 p-3"><i class="bi bi-wifi fs-4 text-primary"></i></div>
                <div>
                    <div class="text-muted small fw-semibold text-uppercase" style="font-size:.7rem;letter-spacing:.5px">Total WiFi</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-3">
        <h6 class="mb-0 fw-bold">Liste des Points d'accès WiFi</h6>
    </div>
    <div class="card-body p-0">
        ...
        <table id="wifi-table"
               data-toggle="table"
               data-url="{{ route('parc-info.wifi.data') }}"
               ...
               data-page-size="25"
               data-query-params="wifiQueryParams"
...
@include('parcinfo::informatique.wifi._wizard')
