<div class="modal fade" id="brassageModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius:16px">
            ...
            <div class="modal-header border-0 px-4 pt-4 pb-0">
                <div>
                    <h5 class="modal-title fw-bold mb-0" id="wizard-title">Ajouter un panneau de brassage</h5>
                    <small class="text-muted" id="wizard-subtitle">Gestion de l'infrastructure réseau passive — CHU Yalgado</small>
                </div>
            ...
            <form id="brassageForm" novalidate>
                @csrf
                <input type="hidden" id="bras_id" name="id">
                ...
                <div class="modal-body px-4 py-3" style="min-height:340px">
                    ...
                    <div id="step-1" class="wizard-step">
                        ...
                        <p class="text-muted text-center small mb-4">Définissez l'état actuel de ce panneau de brassage dans l'inventaire hospitalier.</p>
                        <div class="d-flex flex-column gap-2" id="statut-options">
                            @foreach([
                                ['en_stock',      'bi-archive',       'En stock',      'Disponible en magasin, non déployé'],
                                ['en_service',    'bi-grid-3x3-gap',  'En service',    'Actuellement installé dans une baie réseau'],
                    ...
                    <div id="step-2" class="wizard-step d-none">
                        <h6 class="fw-bold mb-3"><i class="bi bi-info-circle text-primary me-2"></i>Informations du panneau de brassage</h6>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label field-label">Code Inventaire</label>
                                <input type="text" class="form-control field-input bg-light" name="code_inventaire" id="code_inventaire" placeholder="Généré automatiquement (BRAS-AAAA-NNNN)" readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" class="form-control field-input" name="modele" id="modele" placeholder="Ex: Patch Panel CAT6 24 ports" required>
                            </div>

                            {{-- Spécificités Brassage --}}
                            <div class="col-12">
                                <hr class="my-1">
                                <h6 class="fw-bold mb-2 text-primary small text-uppercase"><i class="bi bi-grid-3x3-gap me-1"></i>Spécifications du panneau</h6>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label field-label">Nombre de ports <span class="text-danger">*</span></label>
                                <input type="number" class="form-control field-input" name="nb_ports" id="nb_ports" placeholder="Ex: 24" min="1" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label field-label">Catégorie câble</label>
                                <select class="form-select field-input" name="categorie_cable" id="categorie_cable">
                            ...
                            <div class="col-md-4">
                                <label class="form-label field-label">Type connecteur</label>
                                <input type="text" class="form-control field-input" name="type_connecteur" id="type_connecteur" placeholder="Ex: RJ45, LC, SC">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label field-label">Taille en U</label>
                                <input type="number" class="form-control field-input" name="u_taille" id="u_taille" placeholder="Ex: 1" min="1">
                            </div>
                            <div class="col-md-4">
                    ...
                    <div id="step-3" class="wizard-step d-none">
                        <h6 class="fw-bold mb-3">Emplacement du panneau</h6>
                        <div class="alert alert-info border-0 bg-info bg-opacity-10 mb-4">
                            <i class="bi bi-info-circle-fill text-info me-2"></i>
                            Un panneau de brassage est toujours installé dans un <strong>local technique</strong> (salle réseau, baie de brassage).
                        </div>

                        {{-- Carte LOCAL (seule option) --}}
                        <div class="row g-3 mb-4" id="affectation-type-cards">
                            <div class="col-12">
                                <label class="aff-type-card d-flex align-items-center gap-3 p-3 rounded-3 border cursor-pointer" data-type="LOCAL" data-value="LOCAL" data-bs-toggle="modal" data-bs-target="#localSelectionModal">
                                    ...
                                    <div>
                                        <div class="fw-semibold">Affecter à un local technique</div>
                                        <div class="text-muted small">Salle réseau, armoire de brassage, salle serveurs...</div>
                                    </div>
                                    <i class="bi bi-check-circle-fill text-primary ms-auto check-icon d-none" style="font-size:.9rem"></i>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-3" id="aff-skip-hint">
                            <small class="text-muted">Aucun local sélectionné — l'équipement sera enregistré en stock.</small>
                        </div>
                    </div>
