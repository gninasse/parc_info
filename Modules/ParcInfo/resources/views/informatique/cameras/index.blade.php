...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Caméras IP</li>
@endsection
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="rounded-3 bg-primary bg-opacity-10 p-3"><i class="bi bi-camera-video fs-4 text-primary"></i></div>
                <div>
                    <div class="text-muted small fw-semibold text-uppercase" style="font-size:.7rem;letter-spacing:.5px">Total Caméras</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-3">
        <h6 class="mb-0 fw-bold">Liste des Caméras IP</h6>
    </div>
    <div class="card-body p-0">
        ...
        <table id="cameras-table"
               data-toggle="table"
               data-url="{{ route('parc-info.cameras.data') }}"
               ...
               data-page-size="25"
               data-query-params="camerasQueryParams"
            ...
            <thead class="table-light">
                <tr>
                    ...
                    <th data-field="type_camera" data-sortable="true">Type</th>
...
@include('parcinfo::informatique.cameras._wizard')
...
<script type="module" src="{{ asset('js/modules/parc-info/cameras/index.js') }}?v={{ time() }}"></script>
