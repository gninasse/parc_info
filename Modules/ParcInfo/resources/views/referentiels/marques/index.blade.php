...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body p-0">
        ...
        <table id="items-table"
               data-toggle="table"
               data-url="{{ route('parc-info.referentiels.marques.data') }}"
...
@include('parcinfo::referentiels.marques._modal')
@endsection
...
<script type="module" src="{{ asset('js/modules/parc-info/referentiels/marques.js') }}?v={{ time() }}"></script>
@endpush