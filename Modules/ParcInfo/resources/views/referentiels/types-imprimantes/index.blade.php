...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Types d'Imprimante</li>
@endsection
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-3">
        <h6 class="mb-0 fw-bold">Liste des Types d'Imprimante</h6>
    </div>
    <div class="card-body p-0">
        <div id="toolbar">
            @can('parc-info.referentiels.types-imprimantes.store')
            <button id="btn-add" class="btn btn-primary" data-bs-toggle="tooltip" title="Ajouter">
                <i class="fas fa-plus"></i>
            </button>
            @endcan
            @can('parc-info.referentiels.types-imprimantes.update')
            <button id="btn-edit" class="btn btn-info" disabled data-bs-toggle="tooltip" title="Modifier">
                <i class="fas fa-edit"></i>
            </button>
            @endcan
            @can('parc-info.referentiels.types-imprimantes.destroy')
        ...
        <table id="items-table"
               data-toggle="table"
               data-url="{{ route('parc-info.referentiels.types-imprimantes.data') }}"
...
@include('parcinfo::referentiels.types-imprimantes._modal')
@endsection
...
<script type="module" src="{{ asset('js/modules/parc-info/referentiels/types-imprimantes.js') }}?v={{ time() }}"></script>
@endpush