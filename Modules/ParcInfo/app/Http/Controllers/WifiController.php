...
class WifiController extends Controller
{
    ...
    public function getData(Request $request)
    {
        $query = Equipement::query()
            ...
            ->whereHas('reseau', function ($q) { $q->whereHas('typeReseau', function ($t) { $t->where('libelle', 'ilike', '%wifi%')->orWhere('libelle', 'ilike', '%access point%')->orWhere('libelle', 'ilike', '%point d%'); }); });
