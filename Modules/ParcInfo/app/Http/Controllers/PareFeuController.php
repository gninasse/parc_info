...
{
    /**
     * Display the index view for Pare-feux.
     */
        ...
        $query = Equipement::query()
            ...
            ->whereHas('reseau', function ($q) {
                $q->whereHas('typeReseau', function ($t) {
                    $t->where('libelle', 'ilike', '%pare-feu%')
                        ->orWhere('libelle', 'ilike', '%firewall%');
                });
            });
    ...
    /**
     * Store a newly created Firewall.
     */
    public function store(Request $request): JsonResponse
    {
        $typeReseau = TypeReseau::firstOrCreate(['libelle' => 'Pare-feu']);
        ...
        $equipementId = \DB::transaction(function () use ($request) {
            ...
            EquipementReseau::create([
                ...
                'est_poe' => $request->boolean('est_poe', false),
        ...
        return response()->json([
            'success' => true,
            'message' => 'Pare-feu enregistré avec succès.',
            'equipement_id' => $equipementId,
        ]);
    }

    /**
     * Show a detailed technical view for Firewall.
     */
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        return response()->json(['success' => true, 'message' => 'Pare-feu mis à jour avec succès.']);
    }
    ...
    public function desaffecter(Request $request, $id): JsonResponse
    {
        ...
        return response()->json(['success' => true, 'message' => 'Pare-feu désaffecté et mise en stock.']);
    }
    ...
    public function destroy($id): JsonResponse
    {
        ...
        return response()->json(['success' => true, 'message' => 'Pare-feu supprimé.']);
    }
