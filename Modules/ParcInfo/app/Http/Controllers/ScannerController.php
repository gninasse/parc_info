...
class ScannerController extends Controller
{
    public function index()
    {
        ...
        return view('parcinfo::informatique.scanners.index', compact('sites', 'directions', 'marques'));
    }

    public function getData(Request $request)
    {
        $query = Equipement::query()
            ->with(['marque', 'scanner', 'affectationActive.employe', 'affectationActive.posteTravail', 'affectationActive.local'])
            ->whereHas('scanner');
    ...
    private function formatRow(Equipement $e): array
    {
        ...
        return [
            ...
            'type_capteur' => $e->scanner?->type_capteur ?? '—',
            'statut' => $e->statut,
    ...
    public function store(Request $request)
    {
        if (! $request->filled('code_inventaire')) {
            ...
            $request->merge(['code_inventaire' => 'SCN-'.date('Y').'-'.str_pad($nextId, 4, '0', STR_PAD_LEFT)]);
        }
        ...
        $request->validate([
            ...
            'resolution_dpi_max' => 'nullable|integer|min:72|max:9600',
            'format_max' => 'nullable|string|max:10',
            'type_capteur' => 'nullable|string|max:50',
            'adresse_ip' => 'nullable|ip',
            'interface_connexion' => 'nullable|string|max:100',
        ...
        $equipementId = DB::transaction(function () use ($request) {
            ...
            Scanner::create([
                ...
                'type_capteur' => $request->type_capteur,
                'adresse_ip' => $request->adresse_ip,
                'interface_connexion' => $request->interface_connexion,
            ]);
            ...
            HistoriqueChangement::create([
                ...
                'motif' => 'Enregistrement initial du scanner',
            ]);
        ...
        return response()->json(['success' => true, 'message' => 'Scanner enregistré avec succès.', 'equipement_id' => $equipementId]);
    }
    ...
    public function show($id)
    {
        $equipement = Equipement::with([
            ...
            'affectations.employe', 'affectations.posteTravail',
            'affectations.local', 'affectations.direction',
            'historique',
        ])->findOrFail($id);
        ...
        return view('parcinfo::informatique.scanners.show', compact('equipement', 'marques', 'sites', 'directions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::transaction(function () use ($request, $id) {
            ...
            $equipement->scanner->update($request->only([
                'resolution_dpi_max', 'format_max', 'est_recto_verso',
                'a_chargeur_auto', 'type_capteur', 'adresse_ip', 'interface_connexion',
            ]));
        ...
        return response()->json(['success' => true, 'message' => 'Scanner mis à jour avec succès.']);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Scanner supprimé.']);
    }
