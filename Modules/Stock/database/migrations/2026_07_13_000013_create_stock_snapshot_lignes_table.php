...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('stock_snapshot_lignes', function (Blueprint $table) {
            ...
            $table->decimal('valeur_fifo', 14, 2)->default(0.00);
            $table->decimal('cout_unitaire_moyen', 12, 4)->default(0.00);
            $table->timestamps();

            $table->unique(['snapshot_id', 'magasin_id', 'article_id'], 'unique_snapshot_magasin_article');
        });
    }
