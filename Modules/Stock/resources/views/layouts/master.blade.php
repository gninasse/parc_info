...
<html lang="fr">
  ...
  <head>
    ...
    <title>@yield('title', 'Stock - CHU-YO')</title>
    ...
    <meta name="title" content="CHU-YO Stock" />
    <meta name="author" content="ibrahim" />
    <meta name="description" content="Gestion des stocks CHU-YO" />
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">@yield('header', 'Tableau de bord Stock')</h3></div>
              <div class="col-sm-6">
      ...
      <footer class="app-footer">
        <div class="float-end d-none d-sm-inline">CHU-YO | Module Stock</div>
