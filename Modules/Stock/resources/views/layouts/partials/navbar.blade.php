        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item d-none d-md-block ms-3">
                <a href="{{ route('stock.dashboard') }}" class="btn btn-sm btn-outline-primary fw-bold {{ request()->routeIs('stock.dashboard') ? 'active' : '' }}">
                    <i class="bi bi-speedometer2 me-1"></i> TABLEAU DE BORD
                </a>
            </li>
            @if(Route::has('stock.niveaux.index'))
            <li class="nav-item d-none d-md-block ms-2">
                <a href="{{ route('stock.niveaux.index') }}" class="btn btn-sm btn-outline-primary fw-bold {{ request()->routeIs('stock.niveaux.*') ? 'active' : '' }}">
                    <i class="bi bi-clipboard-data me-1"></i> ÉTAT DES STOCKS
                </a>
            </li>
            @endif
          </ul>
