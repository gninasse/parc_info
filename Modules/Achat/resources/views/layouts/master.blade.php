...
<html lang="fr">
  ...
  <head>
    ...
    <title>@yield('title', 'Achat - CHU-YO')</title>
    ...
    <meta name="title" content="CHU-YO Achat" />
    <meta name="author" content="ibrahim" />
    <meta name="description" content="Chaîne d'engagement fournisseur CHU-YO" />
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      @include('achat::layouts.partials.navbar')

      @include('achat::layouts.partials.sidebar')
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">@yield('header', 'Tableau de bord Achat')</h3></div>
              <div class="col-sm-6">
