    ...
    function init() {
        ...
        $('.btn-add-nomenclature').on('click', function() {
            ...
            if (type === 'marque') {
                ...
                quickAdd('Nouveau type d\'équipement', 'Ex: Switch, Routeur...', 'parc-info.onduleurs.store-type', 'type_infra_id');
            }
        });
        ...
        $form().on('submit', function (e) {
            ...
            const id = $('#res_id').val();
            const url = id ? route('parc-info.onduleurs.update', id) : route('parc-info.onduleurs.store');
