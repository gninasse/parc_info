/**
 * Gestion des Éditeurs - Module Parc Info
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function editItem(id) {
        $.ajax({
            url: route('parc-info.referentiels.editeurs.show', id),
            method: 'GET',
            success: function(res) {
                ...
                $form.find('[name="site_web"]').val(d.site_web);
                $form.find('[name="email_support"]').val(d.email_support);
                $form.find('[name="telephone_support"]').val(d.telephone_support);
                $form.find('[name="est_actif"]').prop('checked', !!d.est_actif);
    ...
    $form.on('submit', function(e) {
        ...
        const url = id 
            ? route('parc-info.referentiels.editeurs.update', id) 
            : route('parc-info.referentiels.editeurs.store');
        ...
        $btnDelete.on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: route('parc-info.referentiels.editeurs.destroy', row.id),
                        method: 'DELETE',
                        data: {
