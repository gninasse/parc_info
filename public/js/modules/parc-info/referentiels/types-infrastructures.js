/**
 * Gestion des Types d'Infrastructure - Module Parc Info
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function editItem(id) {
        $.ajax({
            url: route('parc-info.referentiels.types-infrastructures.show', id),
            method: 'GET',
    ...
    $form.on('submit', function(e) {
        ...
        const url = id 
            ? route('parc-info.referentiels.types-infrastructures.update', id) 
            : route('parc-info.referentiels.types-infrastructures.store');
        ...
        $btnDelete.on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: route('parc-info.referentiels.types-infrastructures.destroy', row.id),
                        method: 'DELETE',
                        data: {
