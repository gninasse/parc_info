/**
 * Gestion des Types de Mobile - Module Parc Info
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function editItem(id) {
        $.ajax({
            url: route('parc-info.referentiels.types-mobiles.show', id),
            method: 'GET',
    ...
    $form.on('submit', function(e) {
        ...
        const url = id 
            ? route('parc-info.referentiels.types-mobiles.update', id) 
            : route('parc-info.referentiels.types-mobiles.store');
        ...
        $btnDelete.on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: route('parc-info.referentiels.types-mobiles.destroy', row.id),
                        method: 'DELETE',
                        data: {
