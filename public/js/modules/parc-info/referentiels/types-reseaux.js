/**
 * Gestion des Types de Réseau - Module Parc Info
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function editItem(id) {
        $.ajax({
            url: route('parc-info.referentiels.types-reseaux.show', id),
            method: 'GET',
    ...
    $form.on('submit', function(e) {
        ...
        const url = id 
            ? route('parc-info.referentiels.types-reseaux.update', id) 
            : route('parc-info.referentiels.types-reseaux.store');
        ...
        $btnDelete.on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: route('parc-info.referentiels.types-reseaux.destroy', row.id),
                        method: 'DELETE',
                        data: {
