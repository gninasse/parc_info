/**
 * Gestion des Types de Licence - Module Parc Info
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function editItem(id) {
        $.ajax({
            url: route('parc-info.referentiels.types-licences.show', id),
            method: 'GET',
    ...
    $form.on('submit', function(e) {
        ...
        const url = id 
            ? route('parc-info.referentiels.types-licences.update', id) 
            : route('parc-info.referentiels.types-licences.store');
        ...
        $btnDelete.on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: route('parc-info.referentiels.types-licences.destroy', row.id),
                        method: 'DELETE',
                        data: {
