    ...
    function init() {
        ...
        $('.btn-add-nomenclature').on('click', function() {
            ...
            if (type === 'marque') {
                ...
                quickAdd('Nouveau type d\'équipement', 'Ex: Switch, Routeur...', 'parc-info.parefeux.store-type', 'type_reseau_id');
            }
        });
        ...
        $form().on('submit', function (e) {
            ...
            const id = $('#res_id').val();
            const url = id ? route('parc-info.parefeux.update', id) : route('parc-info.parefeux.store');
