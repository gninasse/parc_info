...
window.reseauxQueryParams = (params) => {
    return Object.assign(params, {
        type_camera_id: $('#filter-type').val(),
    ...
    function init() {
        ...
        $('.btn-add-nomenclature').on('click', function() {
            ...
            if (type === 'marque') {
                ...
                quickAdd('Nouveau type d\'équipement', 'Ex: Switch, Routeur...', 'parc-info.cameras.store-type', 'type_camera_id');
            }
        });
        ...
        $form().on('submit', function (e) {
            ...
            const id = $('#res_id').val();
            const url = id ? route('parc-info.cameras.update', id) : route('parc-info.cameras.store');
