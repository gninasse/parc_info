...
- [ ] Task: Create `DashboardController` in the `ParcInfo` or `Core` module.
    - [ ] Write Tests for dashboard access (RBAC checking).
    - [ ] Implement `index` method returning the dashboard view.
